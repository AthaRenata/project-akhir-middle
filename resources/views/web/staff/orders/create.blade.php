...
<div class="min-vh-100 container py-5">
    <h2 class="text-theme3">
        <a href="/orders" class="text-theme3" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Pesanan" ><i class="bi-table fs-1"></i></a>
    ...
    <div class="w-100 my-2 overflow-auto bg-theme1 rounded shadow-md" style="white-space: nowrap;">
        ...
        <form action="/orders/create">
          <a href="/orders/create"><span class="badge p-3 mx-1 rounded-pill text-bg-secondary">Semua Kategori</span></a>
