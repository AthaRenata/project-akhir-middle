...
<div class="min-vh-100 container py-5">
    ...
    <div class="d-flex justify-content-end my-3">
        <a href="/customers/create" class="btn btn-primary text-decoration-none">
        ...
        <table class="table table-hover">
            ...
            @if ($customer->created_at->isToday())
                    <tr>
                        ...
                        <td>
                            <a href="/customers/{{$customer->username}}/edit" class="btn btn-warning"  data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Ubah Data"><i class="bi-pencil"></i></a>
                            <form action="/customers/{{$customer->username}}" method="POST" class="d-inline">
                                @method('delete')
                                @csrf
