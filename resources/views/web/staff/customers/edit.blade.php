...
<div class="min-vh-100 container py-5">
    <h2 class="text-theme3">
        <a href="/customers" class="text-theme3" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-original-title="Pelanggan" ><i class="bi-people-fill fs-1"></i></a>
        <i class="bi-caret-right-fill fs-1"></i>
        Ubah Pelanggan
    </h2>

    <div class="mt-2 p-3 text-theme2 bg-theme3 rounded">
        <form action="/customers/{{$customer->username}}" method="POST">
            @method('put')
            @csrf
            <div class="mb-3">
